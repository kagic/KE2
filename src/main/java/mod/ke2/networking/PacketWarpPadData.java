...
public class PacketWarpPadData implements IMessage {
	...
	public PacketWarpPadData(NBTTagCompound padDataCompound, int x, int y, int z) {
	...
	public static class PadDataMessageHandler implements IMessageHandler<PacketWarpPadData, IMessage> {
		@Override
		public IMessage onMessage(PacketWarpPadData message, MessageContext ctx) {
		...
		private void handle(PacketWarpPadData message, MessageContext ctx) {
