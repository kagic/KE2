...
public class ModelBismuth extends ModelGem {
	public ModelBismuth() {
		...
		this.bipedBody.addBox(-6.0F, -4.0F, -3.0F, 12, 16, 6, 0.0F);
		this.bipedSkirt = new ModelRenderer(this, 32, 38);
		this.bipedSkirt.addBox(-6.0F, 8.0F, -3.0F, 12, 8, 6, 0.5F);
		this.bipedBody.addChild(this.bipedSkirt);
		this.bipedRightArm = new ModelRenderer(this, 16, 38);
		this.bipedRightArm.addBox(-6.0F, -4.0F, -2.5F, 5, 14, 5, 0.0F);
		this.bipedLeftArm = new ModelRenderer(this, 0, 38);
		this.bipedLeftArm.addBox(1.0F, -4.0F, -2.5F, 5, 14, 5, 0.0F);
		this.bipedRightLeg = new ModelRenderer(this, 48, 38);
		this.bipedRightLeg.addBox(-6.0F, 0.0F, -2.0F, 4, 12, 4);
