...
public class GuiFactionRequest extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.buttonList.size() == 2) {
        	...
        	this.buttonList.get(0).x = this.width / 2 - 45;	this.buttonList.get(0).y = this.height / 2;
        	this.buttonList.get(1).x = this.width / 2 + 5;	this.buttonList.get(1).y = this.height / 2;
