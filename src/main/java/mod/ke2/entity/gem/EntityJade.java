...
public class EntityJade extends EntityGem {
	...
	static {
		...
		EntityJade.JADE_COLORS.add(new TagType(50, "ke2:jade.color.green"));	// jump boost
		...
		EntityJade.JADE_COLORS.add(new TagType(5,  "ke2:jade.color.orange"));	// fire resistance
		...
		EntityJade.JADE_COLORS.add(new TagType(1,  "ke2:jade.color.black"));	// wither (to enemies)
	...
	public EntityJade(World world) {
		super(world);
		this.dataManager.register(JADE_COLOR, "ke2:jade.color.green");
		this.dataManager.register(JADE_SHAPE, "ke2:jade.shape.bell");
	}
	@Override
	...
	public String getJadeColor() {
		return this.dataManager.get(JADE_COLOR);
	}
	public String generateJadeColor() {
		return TagType.weigh(JADE_COLORS).getTag();
	}
	public void setJadeShape(String shape) {
		this.dataManager.set(JADE_SHAPE, shape);
	}
	public String getJadeShape() {
		return this.dataManager.get(JADE_SHAPE);
	}
	public String generateJadeShape() {
		return TagType.weigh(JADE_SHAPES).getTag();
	}
}
