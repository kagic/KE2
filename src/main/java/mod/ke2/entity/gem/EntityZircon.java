...
public class EntityZircon extends EntityGem {
	...
	public EntityZircon(World world) {
		super(world);
		this.dataManager.register(ZIRCON_COLOR, "ke2:zircon.color.blue");
	}
	@Override
	...
	public void setZirconColor(String color) {
		this.dataManager.set(ZIRCON_COLOR, color);
	}
	public String getZirconColor() {
		return this.dataManager.get(ZIRCON_COLOR);
	}
	public String generateZirconColor() {
		return TagType.weigh(ZIRCON_COLORS).getTag();
	}
}
