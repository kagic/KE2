...
public class EntityPearl extends EntityGem {
	...
	public EntityPearl(World world) {
		super(world);
		this.dataManager.register(PEARL_COLOR, "ke2:pearl.color.blue");
	}
	@Override
	...
	public void setPearlColor(String color) {
		this.dataManager.set(PEARL_COLOR, color);
	}
	public String getPearlColor() {
		return this.dataManager.get(PEARL_COLOR);
	}
	public String generatePearlColor() {
		return TagType.weigh(PEARL_COLORS).getTag();
	}
}
