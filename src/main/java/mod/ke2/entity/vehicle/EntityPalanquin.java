...
public class EntityPalanquin extends EntityGemMachine implements IJumpingMount {
	...
	public EntityPalanquin(World world) {
		...
		// EntityAIMachineFollowPlayer(this, 0.6D));
		this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.4D);
		this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(20.0D);
		this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(20.0D);
		this.dataManager.register(EntityPalanquin.BODY_COLOR, world.rand.nextInt(16));
		this.dataManager.register(EntityPalanquin.HIGHLIGHT_COLOR, world.rand.nextInt(16));
