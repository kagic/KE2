...
public class EntityAIFindInjectionPoint extends EntityAIMoveToBlock {
	...
	public void updateTask() {
		...
		if (this.getIsAboveDestination()) {
			...
			/*
			 * if
			 * (Ke2Blocks.GEM_SEED.getGemSeed(this.injector.
			 * world, point) != null) { TileEntityGemSeed
			 * seed =
			 * Ke2Blocks.GEM_SEED.getGemSeed(this.injector.
			 * world, point); seed.setData(new
			 * GemSpawnData(this.injector.getLatestOwnerID(
			 * true), this.injector.getColor()));
			 * this.injector.setSeedCount(this.injector.
			 * getSeedCount() - 1); }
			 */
		}
	}
