...
public class Ke2Gems {
	...
	/**
	 * Emotional phase at which the gem has everything it
	 * needs and is most efficient.
	 */
	public static final float EMOPHASE_PLEASED = 470.0F;
	/**
	 * Natural emotional phase for most gems; often
	 * accompanies positive bias.
	 */
	public static final float EMOPHASE_RELAXED = 530.0F;
	/**
	 * Natural emotional phase for most gems; often
	 * accompanies negative bias.
	 */
	public static final float EMOPHASE_NERVOUS = 600.0F;
	/**
	 * Emotional phase at which the gem has lost something
	 * it needs and is least efficient.
	 */
	public static final float EMOPHASE_SADNESS = 660.0F;
	/**
	 * Emotional phase at which surrender and fights occur
