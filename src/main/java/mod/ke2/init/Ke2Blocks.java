...
public class Ke2Blocks {
	...
	public static void register(RegistryEvent.Register<Block> event) {
		...
		Ke2Blocks.registerBlock(Ke2Blocks.BANDED_PURPLE_DRAIN_SLAB, new ResourceLocation("ke2:banded_purple_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.DARK_PURPLE_DRAIN_BLOCK, new ResourceLocation("ke2:dark_purple_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.DARK_PURPLE_DRAIN_SLAB, new ResourceLocation("ke2:dark_purple_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.ERODED_PURPLE_DRAIN_BLOCK, new ResourceLocation("ke2:eroded_purple_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHT_ORANGE_DRAIN_BLOCK, new ResourceLocation("ke2:light_orange_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHT_ORANGE_DRAIN_SLAB, new ResourceLocation("ke2:light_orange_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.BANDED_ORANGE_DRAIN_BLOCK, new ResourceLocation("ke2:banded_orange_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.BANDED_ORANGE_DRAIN_SLAB, new ResourceLocation("ke2:banded_orange_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.DARK_ORANGE_DRAIN_BLOCK, new ResourceLocation("ke2:dark_orange_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.DARK_ORANGE_DRAIN_SLAB, new ResourceLocation("ke2:dark_orange_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.ERODED_ORANGE_DRAIN_BLOCK, new ResourceLocation("ke2:eroded_orange_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHT_BLUE_DRAIN_BLOCK, new ResourceLocation("ke2:light_blue_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHT_BLUE_DRAIN_SLAB, new ResourceLocation("ke2:light_blue_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.BANDED_BLUE_DRAIN_BLOCK, new ResourceLocation("ke2:banded_blue_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.BANDED_BLUE_DRAIN_SLAB, new ResourceLocation("ke2:banded_blue_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.DARK_BLUE_DRAIN_BLOCK, new ResourceLocation("ke2:dark_blue_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.DARK_BLUE_DRAIN_SLAB, new ResourceLocation("ke2:dark_blue_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.ERODED_BLUE_DRAIN_BLOCK, new ResourceLocation("ke2:eroded_blue_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHT_RED_DRAIN_BLOCK, new ResourceLocation("ke2:light_red_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHT_RED_DRAIN_SLAB, new ResourceLocation("ke2:light_red_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.BANDED_RED_DRAIN_BLOCK, new ResourceLocation("ke2:banded_red_drain_block"), event, Ke2CreativeTabs.GEM_CREATION);
		Ke2Blocks.registerBlock(Ke2Blocks.BANDED_RED_DRAIN_SLAB, new ResourceLocation("ke2:banded_red_drain_slab"), event, Ke2CreativeTabs.GEM_CREATION);
		...
		Ke2Blocks.registerBlock(Ke2Blocks.WHITE_CARBONITE_ON, new ResourceLocation("ke2:white_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.WHITE_DECORATIVE_CARBONITE, new ResourceLocation("ke2:white_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.WHITE_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:white_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.WHITE_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:white_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_CARBONITE, new ResourceLocation("ke2:orange_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_CARBONITE_STAIRS, new ResourceLocation("ke2:orange_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_CARBONITE_OFF, new ResourceLocation("ke2:orange_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_CARBONITE_ON, new ResourceLocation("ke2:orange_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_DECORATIVE_CARBONITE, new ResourceLocation("ke2:orange_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:orange_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:orange_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_CARBONITE, new ResourceLocation("ke2:magenta_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_CARBONITE_STAIRS, new ResourceLocation("ke2:magenta_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_CARBONITE_OFF, new ResourceLocation("ke2:magenta_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_CARBONITE_ON, new ResourceLocation("ke2:magenta_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_DECORATIVE_CARBONITE, new ResourceLocation("ke2:magenta_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:magenta_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:magenta_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_CARBONITE, new ResourceLocation("ke2:lightblue_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_CARBONITE_STAIRS, new ResourceLocation("ke2:lightblue_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_CARBONITE_OFF, new ResourceLocation("ke2:lightblue_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_CARBONITE_ON, new ResourceLocation("ke2:lightblue_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_DECORATIVE_CARBONITE, new ResourceLocation("ke2:lightblue_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:lightblue_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:lightblue_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_CARBONITE, new ResourceLocation("ke2:yellow_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_CARBONITE_STAIRS, new ResourceLocation("ke2:yellow_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_CARBONITE_OFF, new ResourceLocation("ke2:yellow_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_CARBONITE_ON, new ResourceLocation("ke2:yellow_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_DECORATIVE_CARBONITE, new ResourceLocation("ke2:yellow_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:yellow_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:yellow_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_CARBONITE, new ResourceLocation("ke2:lime_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_CARBONITE_STAIRS, new ResourceLocation("ke2:lime_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_CARBONITE_OFF, new ResourceLocation("ke2:lime_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_CARBONITE_ON, new ResourceLocation("ke2:lime_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_DECORATIVE_CARBONITE, new ResourceLocation("ke2:lime_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:lime_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:lime_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_CARBONITE, new ResourceLocation("ke2:pink_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_CARBONITE_STAIRS, new ResourceLocation("ke2:pink_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_CARBONITE_OFF, new ResourceLocation("ke2:pink_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_CARBONITE_ON, new ResourceLocation("ke2:pink_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_DECORATIVE_CARBONITE, new ResourceLocation("ke2:pink_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:pink_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:pink_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_CARBONITE, new ResourceLocation("ke2:gray_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_CARBONITE_STAIRS, new ResourceLocation("ke2:gray_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_CARBONITE_OFF, new ResourceLocation("ke2:gray_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_CARBONITE_ON, new ResourceLocation("ke2:gray_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_DECORATIVE_CARBONITE, new ResourceLocation("ke2:gray_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:gray_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:gray_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_CARBONITE, new ResourceLocation("ke2:silver_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_CARBONITE_STAIRS, new ResourceLocation("ke2:silver_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_CARBONITE_OFF, new ResourceLocation("ke2:silver_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_CARBONITE_ON, new ResourceLocation("ke2:silver_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_DECORATIVE_CARBONITE, new ResourceLocation("ke2:silver_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:silver_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:silver_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_CARBONITE, new ResourceLocation("ke2:cyan_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_CARBONITE_STAIRS, new ResourceLocation("ke2:cyan_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_CARBONITE_OFF, new ResourceLocation("ke2:cyan_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_CARBONITE_ON, new ResourceLocation("ke2:cyan_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_DECORATIVE_CARBONITE, new ResourceLocation("ke2:cyan_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:cyan_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:cyan_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_CARBONITE, new ResourceLocation("ke2:purple_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_CARBONITE_STAIRS, new ResourceLocation("ke2:purple_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_CARBONITE_OFF, new ResourceLocation("ke2:purple_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_CARBONITE_ON, new ResourceLocation("ke2:purple_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_DECORATIVE_CARBONITE, new ResourceLocation("ke2:purple_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:purple_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:purple_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_CARBONITE, new ResourceLocation("ke2:blue_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_CARBONITE_STAIRS, new ResourceLocation("ke2:blue_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_CARBONITE_OFF, new ResourceLocation("ke2:blue_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_CARBONITE_ON, new ResourceLocation("ke2:blue_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_DECORATIVE_CARBONITE, new ResourceLocation("ke2:blue_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:blue_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:blue_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_CARBONITE, new ResourceLocation("ke2:brown_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_CARBONITE_STAIRS, new ResourceLocation("ke2:brown_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_CARBONITE_OFF, new ResourceLocation("ke2:brown_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_CARBONITE_ON, new ResourceLocation("ke2:brown_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_DECORATIVE_CARBONITE, new ResourceLocation("ke2:brown_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:brown_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:brown_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_CARBONITE, new ResourceLocation("ke2:green_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_CARBONITE_STAIRS, new ResourceLocation("ke2:green_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_CARBONITE_OFF, new ResourceLocation("ke2:green_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_CARBONITE_ON, new ResourceLocation("ke2:green_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_DECORATIVE_CARBONITE, new ResourceLocation("ke2:green_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:green_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:green_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_CARBONITE, new ResourceLocation("ke2:red_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_CARBONITE_STAIRS, new ResourceLocation("ke2:red_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_CARBONITE_OFF, new ResourceLocation("ke2:red_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_CARBONITE_ON, new ResourceLocation("ke2:red_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_DECORATIVE_CARBONITE, new ResourceLocation("ke2:red_decorative_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_HOLOGRAPHIC_CARBONITE_OFF, new ResourceLocation("ke2:red_holographic_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_HOLOGRAPHIC_CARBONITE_ON, new ResourceLocation("ke2:red_holographic_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLACK_CARBONITE, new ResourceLocation("ke2:black_carbonite"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLACK_CARBONITE_STAIRS, new ResourceLocation("ke2:black_carbonite_stairs"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLACK_CARBONITE_OFF, new ResourceLocation("ke2:black_carbonite_off"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLACK_CARBONITE_ON, new ResourceLocation("ke2:black_carbonite_on"), event, Ke2CreativeTabs.GEM_BLOCKS);
		...
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_WARP_PAD_CORE, new ResourceLocation("ke2:orange_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_WARP_PAD_FRAME, new ResourceLocation("ke2:orange_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.ORANGE_WARP_PAD_EDGE, new ResourceLocation("ke2:orange_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_WARP_PAD_CORE, new ResourceLocation("ke2:magenta_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_WARP_PAD_FRAME, new ResourceLocation("ke2:magenta_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.MAGENTA_WARP_PAD_EDGE, new ResourceLocation("ke2:magenta_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_WARP_PAD_CORE, new ResourceLocation("ke2:lightblue_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_WARP_PAD_FRAME, new ResourceLocation("ke2:lightblue_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIGHTBLUE_WARP_PAD_EDGE, new ResourceLocation("ke2:lightblue_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_WARP_PAD_CORE, new ResourceLocation("ke2:yellow_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_WARP_PAD_FRAME, new ResourceLocation("ke2:yellow_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.YELLOW_WARP_PAD_EDGE, new ResourceLocation("ke2:yellow_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_WARP_PAD_CORE, new ResourceLocation("ke2:lime_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_WARP_PAD_FRAME, new ResourceLocation("ke2:lime_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.LIME_WARP_PAD_EDGE, new ResourceLocation("ke2:lime_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_WARP_PAD_CORE, new ResourceLocation("ke2:pink_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_WARP_PAD_FRAME, new ResourceLocation("ke2:pink_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PINK_WARP_PAD_EDGE, new ResourceLocation("ke2:pink_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_WARP_PAD_CORE, new ResourceLocation("ke2:gray_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_WARP_PAD_FRAME, new ResourceLocation("ke2:gray_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GRAY_WARP_PAD_EDGE, new ResourceLocation("ke2:gray_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_WARP_PAD_CORE, new ResourceLocation("ke2:silver_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_WARP_PAD_FRAME, new ResourceLocation("ke2:silver_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.SILVER_WARP_PAD_EDGE, new ResourceLocation("ke2:silver_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_WARP_PAD_CORE, new ResourceLocation("ke2:cyan_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_WARP_PAD_FRAME, new ResourceLocation("ke2:cyan_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.CYAN_WARP_PAD_EDGE, new ResourceLocation("ke2:cyan_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_WARP_PAD_CORE, new ResourceLocation("ke2:purple_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_WARP_PAD_FRAME, new ResourceLocation("ke2:purple_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.PURPLE_WARP_PAD_EDGE, new ResourceLocation("ke2:purple_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_WARP_PAD_CORE, new ResourceLocation("ke2:blue_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_WARP_PAD_FRAME, new ResourceLocation("ke2:blue_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BLUE_WARP_PAD_EDGE, new ResourceLocation("ke2:blue_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_WARP_PAD_CORE, new ResourceLocation("ke2:brown_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_WARP_PAD_FRAME, new ResourceLocation("ke2:brown_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.BROWN_WARP_PAD_EDGE, new ResourceLocation("ke2:brown_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_WARP_PAD_CORE, new ResourceLocation("ke2:green_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_WARP_PAD_FRAME, new ResourceLocation("ke2:green_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.GREEN_WARP_PAD_EDGE, new ResourceLocation("ke2:green_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_WARP_PAD_CORE, new ResourceLocation("ke2:red_warp_pad_core"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_WARP_PAD_FRAME, new ResourceLocation("ke2:red_warp_pad_frame"), event, Ke2CreativeTabs.GEM_BLOCKS);
		Ke2Blocks.registerBlock(Ke2Blocks.RED_WARP_PAD_EDGE, new ResourceLocation("ke2:red_warp_pad_edge"), event, Ke2CreativeTabs.GEM_BLOCKS);
